...
public class Task extends com.netgrif.application.engine.objects.workflow.domain.Task {
    ...
    public Task(ProcessResourceId _id, String processId, String caseId, String transitionId, TaskLayout layout, I18nString title,
                ...
                Map<String, Boolean> assignedUserPolicy, Map<String, Integer> consumedTokens, Map<String, String> tags, String workspaceId) {
        super(_id, processId, caseId, transitionId, workspaceId, layout, title, caseColor, caseTitle, priority, assignee, user,
