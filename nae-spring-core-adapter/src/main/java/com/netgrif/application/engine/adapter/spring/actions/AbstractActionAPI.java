...
public abstract class AbstractActionAPI {
    ...
    public abstract void change(Field<?> field, Case targetCase, Optional<Task> optionalTargetTask, String attribute, Object newValue);

    public abstract Page<Case> findCases(Predicate predicate, Pageable pageable);

    public abstract Page<Case> findCases(List<CaseSearchRequest> requests, String loggedUserId, Pageable pageable, Locale locale, boolean isIntersection);
    ...
    public abstract Page<Task> findTasks(List<ElasticTaskSearchRequest> requests, String loggedUserId, Pageable pageable, Locale locale, boolean isIntersection);
