...
class DateUtilsTest {
    ...
    void formatsLocalDateAndLocalDateTimeUsingEnginePatterns() {
        assertEquals("29.06.2026", DateUtils.toString(LocalDate.of(2026, Month.JUNE, 29)));
        assertEquals("2026-06-29 14:35", DateUtils.toString(LocalDateTime.of(2026, Month.JUNE, 29, 14, 35, 42)));
    }

    @Test
    void convertsLocalDateToDateAtSystemStartOfDay() {
        LocalDate localDate = LocalDate.of(2026, Month.JUNE, 29);
    ...
    void convertsLocalDateTimeToDateAtSystemZone() {
        LocalDateTime localDateTime = LocalDateTime.of(2026, Month.JUNE, 29, 14, 35, 42);
    ...
    void convertsLocalValuesToRequestedZone() {
        ...
        LocalDate localDate = LocalDate.of(2026, Month.JUNE, 29);
        LocalDateTime localDateTime = LocalDateTime.of(2026, Month.JUNE, 29, 14, 35);
