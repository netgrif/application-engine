...
public record GroupDto(String id, String displayName, String identifier, String ownerUsername,
                       Set<AuthorityDto> authoritySet, Set<ProcessRoleDto> processRoles) implements Serializable {
