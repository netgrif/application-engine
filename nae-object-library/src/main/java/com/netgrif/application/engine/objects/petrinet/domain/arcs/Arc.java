package com.netgrif.application.engine.objects.petrinet.domain.arcs;
...
public class Arc extends PetriNetObject {
    ...
    public Arc(Arc arc) {
        this.setSourceId(arc.sourceId);
        this.setDestinationId(arc.destinationId);
        this.setMultiplicity(arc.multiplicity);
        this.setBreakpoints(arc.breakpoints);
        this.setObjectId(arc.getObjectId());
        this.setImportId(arc.importId);
        this.setReference(arc.reference == null ? null : arc.reference.clone());
    }
