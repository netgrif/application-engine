...
//            Poistník todo
            ...
            field("xfdf:original": "5", "${(value(109015) ?: value(109058)) ?: ''}")
...
//            Poistený
            ...
            field("xfdf:original": "406", "${(value(109029) ?: value(109059)) ?: ''}")
...
//            Udaje o poisteni
            ...
            field("xfdf:original": "108", "${valueBool(109002) ? value(109003) : ''}") //todo date format
//            Údaje o poistnom
...
//            Rekapitulácia poistného
            field("xfdf:original": "110", "${valueRound(305002) ?: ''}")
//            field("xfdf:original": "112", "${valueRound() ?: ''}") //todo
            field("xfdf:original": "114", "${valueRound(306001) ?: ''}")
            field("xfdf:original": "116", "${valueRound(308003) ?: ''}")
//            field("xfdf:original": "118", "${valueRound() ?: ''}") //todo
            field("xfdf:original": "120", "${valueRound(308004) ?: ''}")
            field("xfdf:original": "89323", "${valueRound(308006) ?: ''}")
...
//            field("xfdf:original": "mjjttzeželljsd", "${value() ?: ''}") // todo
//            Úhrada poistného
            field("xfdf:original": "126", "${value(309001) ?: ''}")
...
//            Indexácia poistnej sumy
            field("xfdf:original": "131", "${valueBool(109060) ?: ''}")
//            Základné informácie
...
//            Poistenie nehnutelnosti - plochy
            field("xfdf:original": "32", "${valueRound(105001) ?: ''}")
            field("xfdf:original": "33", "${valueRound(105002) ?: ''}")
            field("xfdf:original": "34", "${valueRound(105003) ?: ''}")
            field("xfdf:original": "adadafcmmklopíágh", "${valueRound(305001) ?: ''}")
            field("xfdf:original": "adsadadgnnggtujkklôôp", "${valueRound(105006) ?: ''}")
            field("xfdf:original": "adadadvvcvbnžťžťtfg", "${valueRound(105036) ?: ''}")
            field("xfdf:original": "jklopopopoéííikkkjk", "${valueRound(305002) ?: ''}")
//            Poistenie vedľajsich stavieb PS
            field("xfdf:original": "500", "${valueRound(105010) ?: ''}")
            field("xfdf:original": "501", "${valueRound(105012) ?: ''}")
            field("xfdf:original": "502", "${valueRound(105014) ?: ''}")
            field("xfdf:original": "503", "${valueRound(105016) ?: ''}")
            field("xfdf:original": "504", "${valueRound(105018) ?: ''}")
            field("xfdf:original": "505", "${valueRound(105020) ?: ''}")
            field("xfdf:original": "506", "${valueRound(105022) ?: ''}")
            field("xfdf:original": "507", "${valueRound(105024) ?: ''}")
            field("xfdf:original": "508", "${valueRound(105026) ?: ''}")
            field("xfdf:original": "509", "${valueRound(105028) ?: ''}")
            field("xfdf:original": "510", "${valueRound(105030) ?: ''}")
//            Poistenie vedľajsich stavieb P
            field("xfdf:original": "513", "${valueRound(305004) ?: ''}")
            field("xfdf:original": "514", "${valueRound(305005) ?: ''}")
            field("xfdf:original": "515", "${valueRound(305006) ?: ''}")
            field("xfdf:original": "516", "${valueRound(305007) ?: ''}")
            field("xfdf:original": "517", "${valueRound(305008) ?: ''}")
            field("xfdf:original": "518", "${valueRound(305009) ?: ''}")
            field("xfdf:original": "519", "${valueRound(305010) ?: ''}")
            field("xfdf:original": "520", "${valueRound(305011) ?: ''}")
            field("xfdf:original": "521", "${valueRound(305012) ?: ''}")
            field("xfdf:original": "522", "${valueRound(305013) ?: ''}")
            field("xfdf:original": "523", "${valueRound(305014) ?: ''}")
//            Poistne garaze
            field("xfdf:original": "527", "${valueRound(105004) ?: ''}")
            field("xfdf:original": "525", "${valueRound(105007) ?: ''}")
            field("xfdf:original": "526", "${valueRound(305003) ?: ''}")
//            Garáž na inej adrese
...
//            Doplnkove nehnutelnosti
            asdasdasdadd("${valueRound(105032) ?: ''}")
            field("xfdf:original": "529", "${valueRound(305015) ?: ''}")
            field("xfdf:original": "528", "${valueRound(105034) ?: ''}")
            field("xfdf:original": "530", "${valueRound(305016) ?: ''}")
//            Poistenie zodp. za skodu - nehnutelnost
            field("xfdf:original": "531", "${value(107001) ?: ''}")
            field("xfdf:original": "532", "${valueRound(308008) ?: ''}")
//            Poistenie domácnosti
            ...
            field("xfdf:original": "72", "${valueRound(106003) ?: ''}")
            field("xfdf:original": "73", "${valueRound(106002) ?: ''}")
            field("xfdf:original": "74", "${valueRound(106022) ?: ''}")
            field("xfdf:original": "vvbcbcvcvcvnmjkl,,,", "${valueRound(306001) ?: ''}")
//            Doplnkové poistenie domácnosti - poistna suma
            field("xfdf:original": "91", "${valueRound(106005) ?: ''}")
            field("xfdf:original": "93", "${valueRound(106007) ?: ''}")
            field("xfdf:original": "95", "${valueRound(106009) ?: ''}")
            field("xfdf:original": "97", "${valueRound(106011) ?: ''}")
            field("xfdf:original": "99", "${valueRound(106013) ?: ''}")
            field("xfdf:original": "101", "${valueRound(106015) ?: ''}")
            field("xfdf:original": "103", "${valueRound(106017) ?: ''}")
            field("xfdf:original": "105", "${valueRound(106019) ?: ''}")
            fvbgggztzhjg("${value(106021) ?: ''}")
//            Doplnkové poistenie domácnosti - poistne
            field("xfdf:original": "92", "${valueRound(306002) ?: ''}")
            field("xfdf:original": "94", "${valueRound(306003) ?: ''}")
            field("xfdf:original": "96", "${valueRound(306004) ?: ''}")
            field("xfdf:original": "98", "${valueRound(306005) ?: ''}")
            field("xfdf:original": "100", "${valueRound(306006) ?: ''}")
            field("xfdf:original": "102", "${valueRound(306007) ?: ''}")
            field("xfdf:original": "104", "${valueRound(306008) ?: ''}")
            field("xfdf:original": "sdasdavkphouíáít", "${valueRound(306009) ?: ''}")
            field("xfdf:original": "fdsfsfsdtttttttgdsfsôôôôô", "${valueRound(306010) ?: ''}")
//            Zodp. za skodu domacnost
            field("xfdf:original": "ôôlll", "${value(107003) ?: ''}")
            ldkdd("${valueRound(308009) ?: ''}")
