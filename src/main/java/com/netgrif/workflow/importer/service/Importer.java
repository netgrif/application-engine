...
//      It has to be here for backwards compatibility of variable arcs
    ...
    private AssignPolicy toAssignPolicy(com.netgrif.workflow.importer.model.AssignPolicy policy) {
    ...
    private DataFocusPolicy toDataFocusPolicy(com.netgrif.workflow.importer.model.DataFocusPolicy policy) {
        if (policy == null || policy.value() == null) {
    ...
    private FinishPolicy toFinishPolicy(com.netgrif.workflow.importer.model.FinishPolicy policy) {
        if (policy == null || policy.value() == null) {
