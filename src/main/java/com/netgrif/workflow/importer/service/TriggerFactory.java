...
public class TriggerFactory {
    ...
    public Trigger buildTrigger(com.netgrif.workflow.importer.model.Trigger trigger) throws IllegalArgumentException, DateTimeParseException {
    ...
    private TimeTrigger buildTimeTrigger(com.netgrif.workflow.importer.model.Trigger trigger) throws DateTimeParseException {
