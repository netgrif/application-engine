...
public class ImpersonationController {
    ...
    public PagedModel<IdentityResource> getImpersonationUserOptions(@RequestBody SearchRequest request, Pageable pageable, PagedResourcesAssembler<IUser> assembler, Authentication auth, Locale locale) {
    ...
    public IdentityResource impersonateByConfig(@PathVariable("id") String configId, Locale locale) throws IllegalImpersonationAttemptException, ImpersonatedUserHasSessionException {
        ...
        return new IdentityResource(new IdentityDTO(identity.transformToUser()), "");
    }

    @Operation(summary = "Impersonate user directly by id", security = {@SecurityRequirement(name = "BasicAuth")})
    @PostMapping("/user/{id}")
    public IdentityResource impersonateUser(@PathVariable("id") String userId, Locale locale) throws IllegalImpersonationAttemptException, ImpersonatedUserHasSessionException {
        Identity identity = userService.getLoggedUser().transformToLoggedUser();
    ...
    @PostMapping("/clear")
    public IdentityResource endImpersonation(Locale locale) {
