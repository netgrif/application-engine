package com.netgrif.application.engine.auth.web.interfaces;
...
import com.netgrif.application.engine.workflow.web.interfaces.IController;
...
public interface IUserController extends IController {
    ...
    IUserResourceHelperService userResourceHelperService();
    ...
    ServerAuthProperties serverAuthProperties();

    IUserFactory userResponseFactory();

    Provider<UserResourceAssembler> userResourceAssemblerProvider();

    ISecurityContextService securityContextService();

    default UserResourceAssembler getUserResourceAssembler(Locale locale, boolean small, String selfRel) {
    ...
    default PagedModel<UserResource> getAll(@RequestParam(value = "small", required = false) Boolean small, Pageable pageable, PagedResourcesAssembler<IUser> assembler, Authentication auth, Locale locale) {
    ...
    default PagedModel<UserResource> search(@RequestParam(value = "small", required = false) Boolean small, @RequestBody UserSearchRequestBody query, Pageable pageable, PagedResourcesAssembler<IUser> assembler, Authentication auth, Locale locale) {
        small = small != null && small;
    ...
    default UserResource getUser(@PathVariable("id") String userId, @RequestParam(value = "small", required = false) Boolean small, Locale locale) {
        small = small != null && small;
    ...
    default UserResource getLoggedUser(@RequestParam(value = "small", required = false) Boolean small, Authentication auth, Locale locale) {
        small = small != null && small;
    ...
    default UserResource updateUser(@PathVariable("id") String userId, @RequestBody UpdateUserRequest updates, Authentication auth, Locale locale) throws UnauthorisedRequestException {
    ...
    default PagedModel<UserResource> getAllWithRole(@RequestBody Set<String> roleIds, @RequestParam(value = "small", required = false) Boolean small, Pageable pageable, PagedResourcesAssembler<IUser> assembler, Locale locale) {
        small = small != null && small;
    ...
    default MessageResource assignRolesToUser(@PathVariable("id") String userId, @RequestBody Set<String> roleIds, Authentication auth) {
        try {
    ...
    default AuthoritiesResources getAllAuthorities() {
    ...
    default MessageResource assignAuthorityToUser(@PathVariable("id") String userId, @RequestBody String authorityId) {
    ...
    default PreferencesResource preferences(Authentication auth) {
    ...
    default MessageResource savePreferences(@RequestBody Preferences preferences, Authentication auth) {
        try {
            String userId = ((LoggedUser) auth.getPrincipal()).getId();
