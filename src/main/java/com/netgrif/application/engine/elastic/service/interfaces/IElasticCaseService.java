...
public interface IElasticCaseService {
    ...
    Page<Case> search(List<CaseSearchRequest> requests, Identity user, Pageable pageable, Locale locale, Boolean isIntersection);

    long count(List<CaseSearchRequest> requests, Identity user, Locale locale, Boolean isIntersection);
