...
public enum MenuItemViewOLD {
    ...
    MenuItemViewOLD(I18nString name, String identifier, List<String> allowedAssociatedViews, boolean isTabbed, boolean isPrimary) {
        this.name = name;
     ...
     * */
    public static List<MenuItemViewOLD> findAllByIsTabbedAndIsPrimary(boolean isTabbed, boolean isPrimary) {
     ...
     * */
    public static List<MenuItemViewOLD> findAllByIsTabbedAndParentIdentifier(boolean isTabbed, String parentIdentifier) {
