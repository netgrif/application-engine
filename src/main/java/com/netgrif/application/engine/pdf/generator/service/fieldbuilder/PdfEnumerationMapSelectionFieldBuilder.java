...
public class PdfEnumerationMapSelectionFieldBuilder extends PdfSelectionFieldBuilder {

    public PdfEnumerationMapSelectionFieldBuilder(PdfResource resource) {
        super(resource);
    }
