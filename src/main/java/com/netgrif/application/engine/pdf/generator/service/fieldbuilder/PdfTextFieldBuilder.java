...
@Component
public class PdfTextFieldBuilder extends PdfFieldBuilder<List<String>> {
    ...
    @Override
    public PdfField<List<String>> buildField(PdfFieldBuildingBlock buildingBlock) {
        this.lastX = buildingBlock.getLastX();
        this.lastY = buildingBlock.getLastY();
        PdfTextField pdfField = new PdfTextField(
                buildingBlock.getDataRef().getField().getStringId(),
                buildingBlock.getDataGroup(),
                buildingBlock.getDataRef().getField().getType()
        );
    ...
    @Override
    public int countValueMultiLineHeight(PdfField<List<String>> pdfField) {
        return pdfField.getValue().size() * resource.getLineHeight() + resource.getPadding();
    }

    @Override
    protected void setupValue(PdfFieldBuildingBlock buildingBlock, PdfField<List<String>> pdfField) {
