...
@Component
public class OddValidation implements IValidator<NumberField> {
    ...
    public void validate(NumberField field, DataField dataField) throws ValidationException {
        ...
        if (value % 2 == 0) {
            throwValidationException(validation, "Invalid value of field [" + field.getImportId() + "], value [" + value + "] is even, but should be odd.");
        }
    }
