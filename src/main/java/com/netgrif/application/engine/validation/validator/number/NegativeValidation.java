...
@Component
public class NegativeValidation implements IValidator<NumberField> {
    ...
    public void validate(NumberField field, DataField dataField) throws ValidationException {
        ...
        if (value > 0) {
            throwValidationException(validation, "Invalid value of field [" + field.getImportId() + "], value [" + value + "] is positive, but should be negative.");
        }
