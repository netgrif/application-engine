...
//    }
//
//    protected LocalisedTaskEventOutcome(String message, List<LocalisedEventOutcome> outcomes, Locale locale, Case aCase, com.netgrif.core.workflow.domain.Task task) {
