...
public class TaskController extends AbstractTaskController {
    ...
    public PagedModel<TaskResource> getMy(Authentication auth, Pageable pageable, PagedResourcesAssembler<Task> assembler) {
        return super.getMy(auth, pageable, assembler);
    }
    ...
    public PagedModel<TaskResource> getMyFinished(Pageable pageable, Authentication auth, PagedResourcesAssembler<Task> assembler) {
        return super.getMyFinished(pageable, auth, assembler);
    }
