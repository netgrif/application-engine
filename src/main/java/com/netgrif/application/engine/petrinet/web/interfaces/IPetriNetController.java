package com.netgrif.application.engine.petrinet.web.interfaces;
...
@Tag(name = "PetriNet")
public interface IPetriNetController extends IController {

    IPetriNetService service();

    FileStorageConfiguration fileStorageConfiguration();

    IProcessRoleService roleService();

    StringToVersionConverter converter();
    ...
    default EntityModel<EventOutcomeWithMessage> importPetriNet(
    ...
    default PetriNetReferenceResources getAll(@RequestParam(value = "indentifier", required = false) String identifier, @RequestParam(value = "version", required = false) String version, Authentication auth, Locale locale) {
    ...
    default PetriNetReferenceResource getOne(@PathVariable("id") String id, Locale locale) {
    ...
    default PetriNetReferenceResource getOne(@PathVariable("identifier") String identifier, @PathVariable("version") String version, Authentication auth, Locale locale) {
    ...
    default TransitionReferencesResource getTransitionReferences(@RequestParam List<String> ids, Authentication auth, Locale locale) {
    ...
    default DataFieldReferencesResource getDataFieldReferences(@RequestBody List<TransitionReference> referenceBody, Locale locale) {
    ...
    default ProcessRolesResource getRoles(@PathVariable("netId") String netId, Locale locale) {
    ...
    default TransactionsResource getTransactions(@PathVariable("netId") String netId, Locale locale) {
    ...
    default FileSystemResource getNetFile(@PathVariable("netId") String netId, @RequestParam(value = "title", required = false) String title, HttpServletResponse response) {
    ...
    default MessageResource deletePetriNet(@PathVariable("id") String processId, Authentication auth) {
    ...
    default String decodeUrl(String s1) {
        if (s1 == null)
            return null;
