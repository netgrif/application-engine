...
@Slf4j
@Primary
public class NextGroupService extends GroupServiceImpl {
...
//
    @Override
    public Group create(String identifier, String title, IUser author) {
        try {
...
//
    ...
    public Group addUser(String userId, String groupId, String realmId) {
        ...
        return super.addUser(userId, groupId, realmId);
    }
