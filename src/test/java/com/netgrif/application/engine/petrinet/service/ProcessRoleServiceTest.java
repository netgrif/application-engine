...
class ProcessRoleServiceTest {
    ...
    @Test
    void shouldFindAllProcessRoles() throws IOException, MissingProcessMetaDataException {
    ...
    @Test
    void shouldFindAllProcessRolesByPetriNet() throws IOException, MissingProcessMetaDataException {
        ImportProcessEventOutcome eventOutcome = petriNetService.importPetriNet(new FileInputStream("src/test/resources/all_data.xml"), VersionType.MAJOR, superCreator.getLoggedSuper());
    ...
    @Test
    void shouldFindAllProcessRolesByImportId() throws IOException, MissingProcessMetaDataException {
        petriNetService.importPetriNet(new FileInputStream("src/test/resources/all_data.xml"), VersionType.MAJOR, superCreator.getLoggedSuper());
    ...
    @Test
    void shouldFindAllProcessRolesByName() throws IOException, MissingProcessMetaDataException {
        petriNetService.importPetriNet(new FileInputStream("src/test/resources/all_data.xml"), VersionType.MAJOR, superCreator.getLoggedSuper());
