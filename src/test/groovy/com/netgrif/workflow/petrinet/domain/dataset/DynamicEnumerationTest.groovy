...
class DynamicEnumerationTest {
    ...
    void testDynamicEnum() {
        ImportPetriNetOutcome optNet = petriNetService.importPetriNet(new FileInputStream("src/test/resources/test_autocomplete_dynamic.xml"), "major", superCreator.getLoggedSuper());
