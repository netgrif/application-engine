...
class WorkflowAuthorizationServiceTest {
    ...
    private Authentication testUserAuth
    ...
    void init() {
        ...
        ImportProcessEventOutcome net = petriNetService.importPetriNet(new FileInputStream("src/test/resources/workflow_authorization_service_test.xml"), VersionType.MAJOR, superCreator.getLoggedSuper())
        assert net.getNet() != null
        this.net = net.getNet()

        ImportProcessEventOutcome netWithUserRefs = petriNetService.importPetriNet(new FileInputStream("src/test/resources/workflow_authorization_service_test_with_userRefs.xml"), VersionType.MAJOR, superCreator.getLoggedSuper())
    ...
    void testDeleteCase() {
        ...
        // fail without CREATE role permission
        ...
        String userCaseId1 = response.outcome.case.stringId
        // fail without DELETE role permission
        ...
        String userCaseId2 = response.outcome.case.stringId
        ...
        result = mvc.perform(post(CREATE_CASE_URL)
                ...
                .andReturn()
        response = parseResult(result)
        String otherUserCaseId = response.outcome.case.stringId
