...
class CachePetriNetServiceTest {
    ...
    @Test
    void cacheTest() {
        assert cacheManager.getCache(cacheProperties.getPetriNetActive()).get("processDeleteTest") == null
        ...
        assert cacheManager.getCache(cacheProperties.getPetriNetActive()).get(testNet.getIdentifier()) == null
        PetriNet test = petriNetService.getActiveVersionByIdentifier(testNet.getIdentifier())
        assert cacheManager.getCache(cacheProperties.getPetriNetActive()).get(testNet.getIdentifier()).get().equals(test)
    }
}
