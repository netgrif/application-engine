...
class NewInitTest {
    ...
    void newInitTest() throws IOException, MissingIconKeyException, MissingPetriNetMetaDataException {
        ...
        Case initTestCase = workflowService.createCase(petriNetService.getActiveVersionByIdentifier("new_init_test").stringId, "New init test", "", superCreator.getLoggedSuper()).getCase()
