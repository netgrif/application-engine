...
class DynamicValidationPerformanceTest {
    ...
    void testValidations() {
        ImportPetriNetEventOutcome optNet1 = petriNetService.importPetriNet(ImportPetriNetParams.with()
                .xmlFile(new FileInputStream("src/test/resources/petriNets/dynamic_validations_performance_test.xml"))
                .releaseType(VersionType.MAJOR)
                .author(superCreator.getLoggedSuper())
                .build())
        ImportPetriNetEventOutcome optNet2 = petriNetService.importPetriNet(ImportPetriNetParams.with()
                .xmlFile(new FileInputStream("src/test/resources/petriNets/dynamic_validations_performance_test_comparison.xml"))
                .releaseType(VersionType.MAJOR)
                .author(superCreator.getLoggedSuper())
                .build())
