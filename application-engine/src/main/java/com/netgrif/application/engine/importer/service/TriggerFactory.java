...
import com.netgrif.application.engine.objects.workflow.domain.triggers.*;
...
public class TriggerFactory {
    ...
    public Trigger buildTrigger(com.netgrif.application.engine.objects.importer.model.Trigger trigger) throws IllegalArgumentException, DateTimeParseException {
    ...
    private TimeTrigger buildTimeTrigger(com.netgrif.application.engine.objects.importer.model.Trigger trigger) throws DateTimeParseException {
