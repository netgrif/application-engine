...
public interface IExportService {
    ...
    OutputStream fillCsvCaseData(List<CaseSearchRequest> requests, File outFile, ExportDataConfig config, int pageSize) throws FileNotFoundException;

    OutputStream fillCsvCaseData(List<CaseSearchRequest> requests, File outFile, ExportDataConfig config, int pageSize, Locale locale) throws FileNotFoundException;

    OutputStream fillCsvCaseData(List<CaseSearchRequest> requests, File outFile, ExportDataConfig config, int pageSize, Locale locale, Boolean isIntersection) throws FileNotFoundException;
    ...
    OutputStream fillCsvTaskData(List<ElasticTaskSearchRequest> requests, File outFile, ExportDataConfig config, int pageSize) throws FileNotFoundException;

    OutputStream fillCsvTaskData(List<ElasticTaskSearchRequest> requests, File outFile, ExportDataConfig config, int pageSize, Locale locale) throws FileNotFoundException;

    OutputStream fillCsvTaskData(List<ElasticTaskSearchRequest> requests, File outFile, ExportDataConfig config, int pageSize, Locale locale, Boolean isIntersection) throws FileNotFoundException;
