...
import com.netgrif.application.engine.objects.importer.model.Property;
import com.netgrif.application.engine.importer.service.throwable.MissingIconKeyException;
import com.netgrif.application.engine.objects.petrinet.domain.Component;
import com.netgrif.application.engine.objects.petrinet.domain.I18nString;
import com.netgrif.application.engine.objects.petrinet.domain.Icon;
...
public class ComponentFactory {
    ...
    public static List<Icon> buildIconsListWithValues(List<com.netgrif.application.engine.objects.importer.model.Icon> iconList, Set<I18nString> values, String fieldId) throws MissingIconKeyException {
        List<Icon> icons = new ArrayList<>();
        for (com.netgrif.application.engine.objects.importer.model.Icon icon : iconList) {
    ...
    public static List<Icon> buildIconsListWithOptions(List<com.netgrif.application.engine.objects.importer.model.Icon> iconList, Map<String, I18nString> options, String fieldId) throws MissingIconKeyException {
        List<Icon> icons = new ArrayList<>();
        for (com.netgrif.application.engine.objects.importer.model.Icon icon : iconList) {
    ...
    public Component buildComponent(com.netgrif.application.engine.objects.importer.model.Component importComponent, Importer importer, Data data) throws MissingIconKeyException {
    ...
    public Component buildComponent(com.netgrif.application.engine.objects.importer.model.Component importComponent, Importer importer, Field field) throws MissingIconKeyException {
        if (importComponent.getProperties() != null && importComponent.getProperties().getOptionIcons() != null) {
    ...
    public Component buildComponent(com.netgrif.application.engine.objects.importer.model.Component importComponent) {
    ...
    private Component resolveComponent(com.netgrif.application.engine.objects.importer.model.Component importComponent, Importer importer, Data data, Field field) throws MissingIconKeyException {
        if (data != null) {
