...
public class ConfigurableMenuService implements IConfigurableMenuService {
     ...
     *                       The options key must match the format generated by the {@link ConfigurableMenuService#getNetsByAuthorAsMapOptions(AbstractUser, Locale)} method
     ...
     * @param processField   a field containing the information about the selected process. The options of this field are assumed to be generated by the {@link ConfigurableMenuService#getNetsByAuthorAsMapOptions(AbstractUser, Locale)} method
