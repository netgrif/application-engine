...
import com.netgrif.application.engine.objects.petrinet.domain.dataset.localised.LocalisedEnumerationMapField;
...
public class EnumerationMapFieldBuilder extends SelectionFieldBuilder {
    ...
    public EnumerationMapFieldBuilder(PdfResourceConfigurationProperties resource) {
        super(resource);
    }
